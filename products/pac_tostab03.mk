...
ifeq (pac_tostab03,$(TARGET_PRODUCT))

# OVERLAY_TARGET adds overlay asset source
OVERLAY_TARGET := pa_tostab03

# AOKP device overlay
PRODUCT_PACKAGE_OVERLAYS += vendor/pac/overlay/aokp/device/common_tablet
...
$(call inherit-product, device/toshiba/tostab03/cm.mk)

PRODUCT_NAME := pac_tostab03
